...
pthread_create(&SB1, NULL,kernel_function_1,encrypted_passwords[i]);
pthread_create(&SB2, NULL,kernel_function_2,encrypted_passwords[i]);

pthread_join(SB1, NULL);
pthread_join(SB2, NULL);
